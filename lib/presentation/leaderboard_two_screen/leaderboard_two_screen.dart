...
class LeaderboardTwoScreen extends GetWidget<LeaderboardTwoController> {
  const LeaderboardTwoScreen({Key? key}) : super(key: key);
        ...
        child:
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              child: Padding(
                ...
                child: Center(child: Text("lbl_gifters".tr,style: TextStyle(color: Colors.white),)),
              ),
              ),
  ...
  Widget _buildFour() {
    return Align(
        ...
        child: Container(
            ...
            decoration: AppDecoration.gradientPinkToTeal
