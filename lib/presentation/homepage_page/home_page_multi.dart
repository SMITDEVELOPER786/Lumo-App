import 'package:muhammad_zubair_s_application4/presentation/heart_view/heart_view.dart';
...
import 'widgets/userprofile_party_item.dart';

class HomepageMultiPage extends StatelessWidget {
  HomepageMultiPage({Key? key})
      : super(
          key: key,
        );
    ...
    return Obx(
      () => GridView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Userprofile1ItemPartyWidget(
            model,
          );
        },
      ),
