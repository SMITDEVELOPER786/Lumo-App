...
import 'package:muhammad_zubair_s_application4/presentation/about_luma_screen/widget/user_recharge_agreemant/controller/user_charge_agreemant_controller.dart';

class UserChargeAgreemantScreen extends StatelessWidget {
   UserChargeAgreemantScreen({Key? key}) : super(key: key);

   final controller=Get.put(UserChargeAgreemantController());
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(
          'user_recharge_agreemant_title'.tr,
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              textTileWidget(
                    title:
                       'user_recharge_agreemant_description'.tr,
