...
class LeaderboardThreeScreen extends GetWidget<LeaderboardThreeController> {
  const LeaderboardThreeScreen({Key? key}) : super(key: key);
        ...
        child:
          ...
          Padding(
              ...
              child: Padding(
                ...
                child: Center(child: Text("lbl_family".tr,style: TextStyle(color: Colors.white),)),
              ),
              ),
        ]));
  }
  ...
  Widget _buildFour() {
    return Align(
        ...
        child: Container(
            ...
            decoration: AppDecoration.gradientOrangeToOrange1
